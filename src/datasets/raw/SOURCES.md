...
| `child_mortality_raw.csv` | Under-5 mortality rate (per 1,000 live births) | Our World in Data / UN IGME + Gapminder | https://ourworldindata.org/grapher/child-mortality.csv?v=1&csvType=full&useColumnShortNames=false |
| `maternal_mortality_raw.csv` | Maternal mortality ratio (per 100,000 live births) | Our World in Data / WHO GHO | https://ourworldindata.org/grapher/maternal-mortality-ratio-who-gho.csv?v=1&csvType=full&useColumnShortNames=false |
